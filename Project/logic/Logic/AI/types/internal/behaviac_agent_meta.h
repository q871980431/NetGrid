...
namespace behaviac
{
	...
	inline void FunctionPointer_behaviac_TestAgent_LogMessage(char* param0) { behaviac::TestAgent::LogMessage(param0); }
	inline void FunctionPointer_behaviac_TestAgent_SayHello() { behaviac::TestAgent::SayHello(); }
}
