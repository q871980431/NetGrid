...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(1685234521u);
			...
			// behaviac::TestAgent
			meta = BEHAVIAC_NEW AgentMeta(3231363923u);
			AgentMeta::GetAgentMetas()[2551020550u] = meta;
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_behaviac_TestAgent_LogMessage));
			meta->RegisterMethod(1505908390u, BEHAVIAC_NEW CAgentStaticMethodVoid(FunctionPointer_behaviac_TestAgent_SayHello));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			...
			AgentMeta::Register<behaviac::TestAgent>("behaviac::TestAgent");
		...
		virtual bool unLoad()
		{
			...
			AgentMeta::UnRegister<behaviac::TestAgent>("behaviac::TestAgent");
